...
// Servo adjustment
#define _DUTY_MAX 1200  // Servo angle: D degree -27
#define _DUTY_NEU 900  // Servo angle: 0 degree  2
#define _DUTY_MIN 600   // Servo angle: E degree  29
#define _SERVO_ANGLE_DIFF 56 // Replace with |D - E| degree
...
void loop() {
  ...
  if(event_dist) {
    ...
    if(dist_target < dist_ema) { // Replace 1 with a proper test expression using dist_target and dist_ema.
      duty_target = _DUTY_NEU - _BANGBANG_RANGE; //_DUTY_MAX; Complete this line using _BANGBANG_RANGE.
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 787+(-(2.75*a_value)) + 0.0024 *a_value*a_value;
